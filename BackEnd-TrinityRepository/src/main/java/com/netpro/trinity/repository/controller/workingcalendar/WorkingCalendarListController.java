...
import com.netpro.trinity.repository.service.workingcalendar.WorkingCalendarListService;
...
public class WorkingCalendarListController {
	...
	public ResponseEntity<?> findWorkingCalendarByWCUid(String uid) {
		try {
	...
	public ResponseEntity<?> deleteWorkingCalendarByWCUid(String uid) {
		try {
