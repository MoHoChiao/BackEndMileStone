package com.netpro.trinity.authc.service;
 ...
 */
@EnableEurekaClient
public class BackEndServiceAuthcApplication {

	private static final Logger LOG = LoggerFactory.getLogger(BackEndServiceAuthcApplication.class);
	...
	public static void main(String[] args) {
		SpringApplication.run(BackEndServiceAuthcApplication.class, args);
	}
}
