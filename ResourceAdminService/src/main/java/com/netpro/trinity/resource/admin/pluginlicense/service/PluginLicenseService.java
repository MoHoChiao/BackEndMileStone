package com.netpro.trinity.resource.admin.pluginlicense.service;
...
import com.netpro.trinity.resource.admin.pluginlicense.dao.PluginLicenseJPADao;
...
//		Collections.sort(pluginListNew, (a, b) -> a.getPluginname().compareToIgnoreCase(b.getPluginname()));
